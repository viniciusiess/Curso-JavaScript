...
// Quando o usuário clicar nos links internos do site, adicione a classe ativa ao item clicado,
// e remova dos demais itens caso eles possuem a mesma. Previna o comportamento padrão desses links
...
function handleClickT(event){
    ...
    if(event.key === 't'){
        document.documentElement.classList.toggle('textomaior'); // classe html css para aumentar o texto
    }
}
